...
## TTS vs 자막 규칙 (매우 중요)
tts_script와 subtitle_text는 반드시 다르게 작성!
- tts_script: 소리로 들을 때 자연스러운 구어체. 길게 풀어서 말하듯이
  예: "아니 근데 진짜 이게 첫날이었거든요... 감자튀김을 통째로 바닥에 쏟아버린 거예요"
- subtitle_text: 화면에 짧게 보이는 텍스트. 핵심만. 임팩트
  예: "첫날 감자튀김 통째로 쏟음"
TTS는 귀로 듣는 거고 자막은 눈으로 스캔하는 거. 같으면 안 됨!

## 훅 규칙
- "퇴사한 알바생이 사실 AI 개발자?" 이런 뻔한 유튜브 제목 스타일 금지!
- 좋은 훅: 구체적 상황으로 시작. "감자튀김 200인분을 바닥에 쏟아버렸습니다..."
- 나쁜 훅: 추상적 질문형. "알바하면서 코딩하면 어떻게 될까?"
